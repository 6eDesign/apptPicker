...
var jDom=function(e,n,t,r){e.extend=function(){return a(arguments)},e.trim=function(){for(var e=[],n=0;n<arguments.length;++n)e.push(i(arguments[n]));return e.length>1?e:e[0]},e.getKeys=function(e){return o(e)},e.isArray=function(e){return"object"==typeof e?f(e):!1},e.ready=function(e){var t=n.onload;n.onload="function"!=typeof n.onload?e:function(){t(),e()}},e.trigger=function(e,n){return s(e,n)},e.on=function(e,n,t){n=u(n);for(var r=0;r<n.length;++r)l(e,n[r],t);return e},e.create=function(e){return c(e)},e.getByClassName=function(e,n){var r=[];return n="undefined"==typeof n?t:n,t.getElementsByClassName?r=n.getElementsByClassName(e):p(e,n)},e.getElementsByData=function(e,n,r,a){return n="undefined"==typeof n?null:n,r="undefined"==typeof r?t:r,a="undefined"==typeof a?"*":a,y(e,n,r,a)},e.getData=function(e){var n=b(e);return n},e.setData=function(e,n,t){if(t="undefined"==typeof t?!1:!0)r.log("WRITE THIS METHOD");else{{a(b(e),n)}r.log("FINISH WRITING THIS METHOD")}},e.addClass=function(e,n){var t="";if("undefined"!=typeof e.className){t=" "+u(e.className).join(" ")+" ",n=u(n);for(var r=0;r<n.length;++r)t.indexOf(" "+n[r]+" ")<0&&(t+=n[r]+" ");e.className=i(t)}else e.className=i(n);return e},e.removeClass=function(e,n,t){if(t="undefined"==typeof t?!0:!1)return m(e,n);for(var r=[],a=0;a<e.length;++a)r.push(m(e[a],n));return r};var a,i,o,u,f;a=function(e){for(var n=e.length-1;n>0;--n)for(var t in e[n]){var r=!0;"undefined"!=typeof e[n-1][t]&&"object"==typeof e[n][t]&&"object"==typeof e[n-1][t]&&(f(e[n])||f(e[n-1])||(r=!1,e[n-1][t]=jDom.extend(e[n-1][t],e[n][t]))),r&&(e[n-1][t]=e[n][t])}return e.length?e[0]:{}},i=function(e){return e.replace(/^\s+|\s+$/g,"")},o=function(e){if(Object.keys)return Object.keys(e);arr=[];for(var n in e)arr.push(n);return arr},u=function(e){return i(e).replace(/[ ]+/," ").split(" ")},f=function(e){return Array.isArray?Array.isArray(e):v instanceof Array};var s,l;s=function(e,n){var r;return t.createEvent?(r=t.createEvent("HTMLEvents"),r.initEvent(n,!0,!0)):(r=t.createEventObject(),r.eventType=n),r.eventName=n,t.createEvent?e.dispatchEvent(r):e.fireEvent("on"+r.eventType,r),e},l=function(e,n){return n.addEventListener?function(n,t,r){if(n&&!n.length||n===e)n.addEventListener(t,r,!1);else if(n&&n.length)for(var a=n.length,i=0;a>i;i++)l(n[i],t,r)}:n.attachEvent?function(n,t,r){if(n&&!n.length||n===e)n.attachEvent("on"+t,function(){return r.call(n,e.event)});else if(n.length)for(var a=n.length,i=0;a>i;i++)l(n[i],t,r)}:void 0}(this,t);var c,d,g;c=function(e){return d(e)},d=function(e){var n,r,a,i,o;if(e.contains=null==e.contains?[]:e.contains,e.attributes=null==e.attributes?{}:e.attributes,e.bindings=null==e.bindings?{}:e.bindings,e.type=null==e.type?"div":e.type,n=g(e.type,e.attributes,e.bindings),r=e.contains,"string"==typeof r)n.appendChild(t.createTextNode(r));else for(a=0;a<r.length;++a)i=r[a],"object"==typeof i?(o=c(i),n.appendChild(o)):n.appendChild(t.createTextNode(i));return n},g=function(e,n,r){var a,i,o;if(a=t.createElement(e),"undefined"!=typeof n)for(i in n)o=n[i],a.setAttribute(i,o);if("undefined"!=typeof r)for(var i in r)"function"==typeof r[i]&&l(a,i,r[i]);return a};var p,y,h,m,b;return p=function(e,n){var t,r=[];t=n.getElementsByTagName("*"),e=u(e);for(var a=0;a<t.length;++a){var i,o=!0;i=" "+u(t[a].className).join(" ")+" ";for(var f=0;f<e.length;++f){var s=" "+e[f]+" ";if(-1==i.indexOf(s)){o=!1;break}}o&&r.push(t[a])}return r},y=function(e,n,t,r){var a,i=[];a=t.getElementsByTagName(r);for(var o=0;o<a.length;++o)a[o].getAttribute("data-"+e)&&(null!=n?a[o].getAttribute("data-"+e)==n&&i.push(a[o]):i.push(a[o]));return i},h=function(e){var n,t={};n=e.attributes;for(var r=0;r<n.length;++r){var a=n.item(r);t[a.nodeName]=a.nodeValue}return t},m=function(e,n){if("undefined"!=typeof e.className){var t,r,a=0;n=u(n),t=u(e.className);for(var i=0;i<t.length;++i){r=0;for(var o=0;o<n.length;++o)if(t[i-a]==n[o]){t.splice(i-a,1),n.splice(o,1),++a;break}}e.className=t.length?t.join(" "):""}return e},b=function(e){var n,t,r={};n=h(e),t=o(n);for(var a=0;a<t.length;++a)0==t[a].indexOf("data-")&&(r[t[a].substring(5,t[a].length)]=n[t[a]]);return r},e}(jDom||{},window,document,console);
