...
var theApptPicker=function(t,e,i,n){var r,s,a,c,p,d,o,k,l,u,g,m,f;c={count:0,pickers:{}},p={start:"9:00am",end:"5:00pm",subinterval:60,interval:15,slidedur:280,opendur:300,height:"351px",opentext:"Choose Time",inputid:!1,changecallback:!1,expandcallback:!1,changetxt:!0},s=function(t,e){e="undefined"==typeof e?!1:!0;var i,n,r;i=[],r=e?t.length:t.length-1;for(var s=0;r>s;++s){var a,c={};e?(a=timeUtils.formatTimeStr(t[s]),c["data-time"]=t[s].getTime()):(a=timeUtils.formatTimeStr(t[s],!0)+" - "+timeUtils.formatTimeStr(t[s+1],!0),c["data-start"]=t[s].getTime(),c["data-end"]=t[s+1].getTime()),c["data-listindex"]=s,i.push({type:"li",attributes:c,contains:a})}return n={type:"ul",attributes:{"class":e?"appt-picker second":"appt-picker first"},contains:i},jDom.create(n)},r=function(t){var r,a,o;r=n.extend({},p,n(t).data()),i.log(r),r.btn=jDom.create("button.appt-picker-button#pickerBtn_"+c.count+"${"+r.opentext+"}"),n(r.btn).on("click",d),t.appendChild(r.btn),a=timeUtils.getTimes(r.start,r.end,r.subinterval),o=timeUtils.getTimes(r.start,r.end,r.interval),a=s(a),o=s(o,!0),t.appendChild(a),t.appendChild(o),t.setAttribute("data-pickerid","picker_"+c.count),r.minimizedheight=t.offsetHeight+"px",0!=r.inputid&&(r.input=e.getElementById(r.inputid),r.input&&(r.input.setAttribute("data-pickerid","picker_"+c.count),r.input.setAttribute("readonly","true"),n(r.input).on("click focus",function(){var t=this.getAttribute("data-pickerid");c.pickers[t].minimized&&n(c.pickers[t].settings.btn).trigger("click")}))),c.pickers["picker_"+c.count]={el:t,minimized:!0,expanded:!1,selecting:!1,start:!1,end:!1,startindex:0,endindex:0,lasthoverindex:-1,settings:r},++c.count},d=function(){var t="picker_"+this.getAttribute("id").split("pickerBtn_").pop();if(c.pickers[t].el.offsetHeight<parseFloat(c.pickers[t].settings.height)){var e=c.pickers[t].settings.height;c.pickers[t].minimized=!1}else{var e=c.pickers[t].settings.minimizedheight;c.pickers[t].minimized=!0}n(c.pickers[t].el).stop(!0,!0).animate({height:e},c.pickers[t].settings.opendur,"easeOutQuad",function(){})},o=function(){var t,e,i,r,s,a;t=this.parentNode,e=t.parentNode,i=e.getElementsByTagName("ul")[1],s=e.getAttribute("data-pickerid"),r=this.getAttribute("data-start"),n(".appt-picker.first>li").removeClass("active"),n(this).addClass("active"),c.pickers[s].expanded||(c.pickers[s].expanded=!0,n(t).stop(!0,!0).animate({width:"40%"},p.slidedur,"easeOutExpo",function(){})),a=n(e).find('ul.appt-picker>li[data-time="'+r+'"]')[0].offsetTop,n(i).animate({scrollTop:a+"px"},300,"easeInOutExpo",function(){})},k=function(t,e,i){var r,s,a;if(r=t.getElementsByTagName("li"),s=Math.min(e,i),a=Math.max(e,i),e-i!=0){n(r).removeClass("pick-start pick-middle pick-end");for(var c=s+1;a>c;++c)n(r[c]).addClass("pick-middle");n(r[s]).addClass("pick-start"),n(r[a]).addClass("pick-end")}},g=function(t){var e;c.pickers[t].start>c.pickers[t].end&&(e=c.pickers[t].start,c.pickers[t].start=c.pickers[t].end,c.pickers[t].end=e)},l=function(){var t,r,s,a;if(t=this.parentNode,r=t.parentNode,a=r.getAttribute("data-pickerid"),s=new Date(parseFloat(this.getAttribute("data-time"))),0==c.pickers[a].selecting)c.pickers[a].selecting=!0,c.pickers[a].end=!1,c.pickers[a].start=s,c.pickers[a].startindex=this.getAttribute("data-listindex"),n(t).find("li").removeClass("pick-start pick-middle pick-end"),n(this).addClass("pick-start"),m(a);else{if(this.getAttribute("data-listindex")!=c.pickers[a].startindex&&(c.pickers[a].selecting=!1,c.pickers[a].end=s,c.pickers[a].endindex=this.getAttribute("data-listindex"),n(this).addClass("pick-end"),k(t,c.pickers[a].startindex,c.pickers[a].endindex),n(c.pickers[a].settings.btn).click(),c.pickers[a].settings.inputid)){g(a);var p=timeUtils.formatTimeStr(c.pickers[a].start)+" to "+timeUtils.formatTimeStr(c.pickers[a].end),d=[c.pickers[a].start.toISOString(),c.pickers[a].end.toISOString()];i.log(d.join(",")),e.getElementById(c.pickers[a].settings.inputid).value=p}m(a)}},u=function(){var t,e,i;i=this.parentNode,t=i.parentNode.getAttribute("data-pickerid"),e=this.getAttribute("data-listindex"),c.pickers[t].selecting&&c.pickers[t].lasthoverindex!=e&&(c.pickers[t].lasthoverindex=e,c.pickers[t].startindex!=e?k(i,c.pickers[t].startindex,e):n(i.getElementsByTagName("li")).removeClass("pick-middle pick-end"))},m=function(t){if(c.pickers[t].settings.changecallback&&c.pickers[t].settings.changecallback(c.pickers[t]),c.pickers[t].settings.changetxt){var e=timeUtils.formatTimeStr(c.pickers[t].start)+" to "+timeUtils.formatTimeStr(c.pickers[t].end);c.pickers[t].settings.btn.innerHTML=e}},f=function(t,e,i){var n=!1;if(n="function"==typeof i?!0:!1,"undefined"!=typeof window[i]&&"function"==typeof window[i]&&(n=!0,i=window[i]),n){var r=t.getAttribute("data-pickerid");if("undefined"!=typeof c.pickers[r])switch(e.toLowerCase()){case"expand":c.pickers[r].settings.expandcallback=i;break;case"change":c.pickers[r].settings.changecallback=i}}},a=function(){n(".apptPicker").each(function(){r(this)}),n(e).on("click",".appt-picker.first>li",o),n(e).on("click",".appt-picker.second>li",l),n(e).on("hover focus",".appt-picker.second>li",u)},t.apptPicker=function(t){var s,a,p,d,o;return d=e.getElementById(t),o=d.getAttribute("data-pickerid"),s=function(e,i){return d?(f(d,e,i),apptPicker(t)):void 0},p=function(){return"undefined"!=typeof c.pickers[o]&&c.pickers[o].start&&c.pickers[o].end?{start:c.pickers[o].start,end:c.pickers[o].end}:!1},a=function(t){if(d){for(var e in t)d.setAttribute("data-"+e,t[e]);return i.log(d),o?apptPicker(d.getAttribute("id")):(r(d),apptPicker(d.getAttribute("id")))}},toggleOpen=function(){return"undefined"!=typeof o?(n(c.pickers[o].settings.btn).click(),apptPicker(d.getAttribute("id"))):void 0},{on:s,getTimes:p,create:a,toggleOpen:toggleOpen}},n(e).ready(a)}(window,document,console,jQuery);